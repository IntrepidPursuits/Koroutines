...
import io.intrepid.koroutines.base.BaseDialogFragment
import java.util.*
...
internal object ButterKnife {
    @JvmStatic
    fun unbind(target: Any) = LazyRegistry.reset(target)
    ...
    private val SupportFragment.viewFinder: SupportFragment.(Int) -> View? get() = { activity.findViewById(it) }
